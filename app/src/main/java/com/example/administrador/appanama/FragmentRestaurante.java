...
public class FragmentRestaurante extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View retView = inflater.inflate(R.layout.fragment_restaurante, container);

        image_slider = (ViewPager) retView.findViewById(R.id.image_slider);
        ViewPagerAdapterRestaurante viewPagerAdapter = new ViewPagerAdapterRestaurante(getActivity());
