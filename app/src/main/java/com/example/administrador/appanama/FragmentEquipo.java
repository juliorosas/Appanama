...
public class FragmentEquipo extends Fragment {
    ...
    int currentPage = 0;
    Timer timer;
    final long DELAY_MS = 650;//delay in milliseconds before task is to be executed
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View retView = inflater.inflate(R.layout.fragment_equipo, container);

        image_slider = (ViewPager) retView.findViewById(R.id.image_slider);
        ViewPagerAdapterEquipo viewPagerAdapter = new ViewPagerAdapterEquipo(getActivity());
